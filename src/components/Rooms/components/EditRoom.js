...
const EditRoom = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    if (isChecked.current.checked) {
      ...
      dispatch(
        notificationSliceActions.warning(
          "Please confirm by checking out checkbox"
        )
      );
      setTimeout(() => {
    ...
    <div className=" h-screen w-3/12 p-5 pt-10 flex flex-col justify-start gap-20">
      ...
      >
        <div className="flex h-9">
          <label className="w-28 text-lg" htmlFor="roomId">
            Room Id
          </label>
          <input
            className="shadow border rounded  py-2 px-3 focus:outline-none focus:shadow-outline ml-4 disabled:bg-gray-100"
            type="text"
            disabled={true}
        ...
        <div className="flex h-9">
          <label className="w-28 text-lg" htmlFor="roomName">
            Room Name
          </label>
          <input
            className="shadow border rounded appearance-none py-2 px-3 focus:outline-none focus:shadow-outline ml-4 text-gray-700"
            type="text"
            required
            value={roomName}
        ...
        <div className="flex h-9">
          <label className="w-28 text-lg" htmlFor="roomPrice">
            Room Price
          </label>
          <CurrencyInput
            className="shadow border rounded appearance-none py-2 px-3 focus:outline-none focus:shadow-outline ml-4 text-gray-700"
        ...
        <div className="flex h-9 items-center">
          ...
          <label className="ml-4 text-sm " htmlFor="roomUpdateCheck">
            Confirm Edit
          </label>
        </div>
